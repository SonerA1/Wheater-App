...
import com.example.weatherapp.view.ForeCastActivity
import com.example.weatherapp.view.WeatherVm
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viM.todayWeatherLiveData.observe(this, Observer {
            val setNewlist: List<WeatherList>? = it
            if (setNewlist != null) {
        ...
        binding.next5Days.setOnClickListener {
            startActivity(
                Intent
                    (this, ForeCastActivity::class.java)
            )
        }
